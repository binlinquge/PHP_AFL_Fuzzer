...
xdebug_start_trace();
 ...
 if($_POST["addparent"] == 1)
 {
  if($_POST["username"] != "" && $_POST["fname"] != "" && $_POST["lname"] != "" && $_POST["student"] != "")
  {
   ...
   $query = mysql_query("INSERT INTO parents VALUES(0, '$_POST[username]', '$_POST[fname]', '$_POST[lname]')")
   ...
   $query = mysql_query("INSERT INTO parent_student_match VALUES(0, '$parentid', '$_POST[student]')")
