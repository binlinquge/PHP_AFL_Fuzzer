...
xdebug_start_trace();
 ...
 if($_POST["addclass"] == 1 && $_POST["title"] != "" && $_POST["teacher"] != "" && $_POST["semester"] != "" && $_POST["roomnum"] != "" && $_POST["periodnum"] != "")
 {
  ...
  $query = mysql_query("INSERT INTO courses VALUES(0, '$_POST[semester]', '$termid', '$_POST[title]', '$_POST[teacher]', '$_POST[sectionnum]', '$_POST[roomnum]', '$_POST[periodnum]',0,0,0,0,0,0,0,0,'$dotw','$_POST[substitute]',NULL)")
  ...
  else
  {
   ...
   $query = mysql_query("INSERT INTO courses VALUES(0, '$_POST[semester2]', '$termid', '$_POST[title]', '$_POST[teacher]', '$_POST[sectionnum]', '$_POST[roomnum]', '$_POST[periodnum]','','','','','','','','','$dotw','$_POST[substitute]', '')")
	or die("ManageClasses.php: Unable to insert new class - " . mysql_error());
