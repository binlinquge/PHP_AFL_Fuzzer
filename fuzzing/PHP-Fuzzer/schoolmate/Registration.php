...
xdebug_start_trace();
 ...
 if($curregs[0] == "")
 {
  ...
  if($insert)
  {
   ...
   $query = mysql_query("INSERT INTO registrations VALUES(0,'$_POST[class]','$_POST[student]', '$_POST[semester]', '$id[0]', 0,0,0)")
   ...
   if($id[0]!=NULL)
	$query = mysql_query("INSERT INTO registrations VALUES(0,'$id[0]','$_POST[student]',0,0,0)");
